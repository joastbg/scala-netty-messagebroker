     ...
     case PathSegments(path :: Nil) => {
      ...
      case Path("/websocket/") => {
        ...
        println(wsHandshake)
              ...
              //actorSystem.scheduler.schedule(15 seconds, 0 minutes, actorSystem.actorOf(Props[net.joastbg.testing.WebSocketPushActor]), Push("kalle", "From scheduler"))
...
//        wsHandshake.channel.
    ...
    case WebSocketFrame(wsFrame) => {
      ...
      actorSystem.actorOf(Props[WebSocketHandler]) ! wsFrame
        ...
        //wsFrame.writeText("hello!!")

      //actorSystem.actorOf(Props[WebSocketPushActor]) ! WebSocketRegistered("kalle", wsFrame.context.channel)
    }
